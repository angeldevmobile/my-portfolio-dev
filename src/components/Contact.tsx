...
const Contact: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch("https://angel-dev-portfolio.netlify.app/.netlify/functions/send-email", {
        method: "POST",
        headers: {
  ...
  return (
    <section
      ...
      style={{ backgroundColor: "rgb(28, 28, 39)" }} // Aplicar color de fondo aquí
    >
      <div className="max-w-3xl px-6 mx-auto text-center">
        ...
        <div className="flex items-center justify-center p-4">
          {" "}
          {/* Añadido padding para un poco de espacio interno */}
          <form className="custom-form" onSubmit={handleSubmit}>
            ...
            <div className="mb-6">
              <input
                ...
                className="w-full p-3 bg-[#171721] border border-[rgb(177,178,179)] rounded focus:outline-none focus:border-blue-500 text-white" // Cambiado el borde
            ...
            <div className="mb-6">
              <textarea
                name="message"
                placeholder="Message"
                className="w-full h-32 p-3 bg-[#171721] border border-[rgb(177,178,179)] rounded resize-none focus:outline-none focus:border-blue-500 text-white" // Cambiado el borde
